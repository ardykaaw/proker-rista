            ...
            >
                ...
                >
                    <div class="flex flex-col h-full">
                        <!-- Header -->
                        <div class="relative p-6 bg-gradient-to-br from-[#0992d6] via-[#0882c0] to-[#0770a8] overflow-hidden">
                            <!-- Background Pattern -->
                            <div class="absolute inset-0 opacity-10">
                                <div class="absolute top-0 right-0 w-24 h-24 bg-white rounded-full -translate-y-12 translate-x-12"></div>
                                <div class="absolute bottom-0 left-0 w-20 h-20 bg-white rounded-full translate-y-10 -translate-x-10"></div>
                            </div>
                            ...
                            <div class="relative flex items-center justify-between">
                                <div class="flex items-center space-x-3">
                                    ...
                                    />
                                    <div>
                                        <h2 class="text-white font-bold text-lg drop-shadow-md">Desa Rakadua</h2>
                                        <p class="text-white/90 text-sm font-medium">Kabupaten Bombana</p>
                                    </div>
                                </div>
                                <button
                                    id="close-mobile-menu"
                                    class="text-white hover:text-white/80 p-2 rounded-lg hover:bg-white/10 transition-all duration-200 backdrop-blur-sm"
                                >
                        ...
                        <div class="p-4 bg-gradient-to-r from-gray-800 to-gray-900 text-white">
                            <div class="text-center">
                                <div class="flex items-center justify-center mb-3">
                                    ...
                                    />
                                    <div class="text-left">
                                        <p class="text-sm font-semibold">Desa Rakadua</p>
                                        <p class="text-xs text-gray-300">Kabupaten Bombana</p>
                                    </div>
                                </div>
                                <p class="text-xs text-gray-400 mb-3">Sulawesi Tenggara, Indonesia</p>
