...
@section('title', 'Login Admin - Desa Rakadua')
...
<div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">Desa Rakadua Management System</p>
        </div>
    </div>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="email" name="email" type="email" autocomplete="email" required 
                               ...
                               value="{{ old('email') }}" placeholder="admin@desabungkutoko.com">
                    </div>
                    @error('email')
            ...
            {{-- <div class="mt-6">
                ...
                <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <div class="text-sm text-blue-700">
                        <p><strong>Email:</strong> admin@desarakadua.com</p>
